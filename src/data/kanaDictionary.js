export const kanaDictionary = {
	'hiragana': {
		...
		'h_group4': { characters: { 'た': ['ta'], 'ち': ['tsji','ti'], 'つ': ['tsu','tu'], 'て': ['te'], 'と': ['tå'] } },
		...
		'h_group9': { characters: { 'ら': ['ɽa','ra'], 'り': ['ɽi','ri'], 'る': ['ɽu','ru'], 'れ': ['ɽe','re'], 'ろ': ['ɽå','rå'] } },
	...
	'katakana': {
		...
		'k_group9': { characters: { 'ラ': ['ɽa','ra'], 'リ': ['ɽi','ri'], 'ル': ['ɽu','ru'], 'レ': ['ɽe','re'], 'ロ': ['ɽå','rå'] } },
