...
class AnswerButton extends Component {
	...
	render() {
		return (
			<button className={this.props.className} onKeyDown={() => this.props.handleKeyButton} onClick={()=>this.props.handleAnswer(this.getShowableAnswer())}>{this.getShowableAnswer()}</button>
		);
	}
}
